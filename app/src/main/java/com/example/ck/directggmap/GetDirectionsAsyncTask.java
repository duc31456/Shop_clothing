package com.example.ck.directggmap;
...
public class GetDirectionsAsyncTask extends AsyncTask<Map<String, String>, Object, ArrayList> {
    ...
    private WeakReference<fragment_map> activity;
    private Exception exception;

     private ProgressDialog progressDialog;

    public GetDirectionsAsyncTask(fragment_map activity) {
        super();
        this.activity = new WeakReference<fragment_map>(activity);
    }
